...
Solving all language tasks and exploring scaling laws with LLMs are so cool. *How about building vision foundation models to unlock vision AGI?* Also, we are now good at handling vision tasks seperately. *How about unifying vision understanding and generation to solve vision tasks all together?*  
...
| [**Gemini: A Family of Highly Capable Multimodal Models**](https://arxiv.org/pdf/2312.11805) | Gemeni | arXiv | 2023-12-06 | Google | - | - |
...
| [**ShapeGPT: 3D Shape Generation with A Unified Multi-modal Language Model**](https://arxiv.org/pdf/2311.17618) | ShapeGPT | arXiv | 2023-11-29 | FDU, Tencent, ShanghaiTech, Zhejiang Lab | [Github](https://arxiv.org/pdf/2311.17618) | - |
...
| [**Harmonizing Visual Text Comprehension and Generation**](https://arxiv.org/pdf/2407.16364) | TextHarmony | NeurIPS | 2024-06-23 | ECNU, ByteDance | [Github](https://github.com/bytedance/TextHarmony) | - |
...
| [**MM-Interleaved: Interleaved Image-Text Generation via Multi-modal Feature Synchronizer**](https://arxiv.org/pdf/2401.10208) | MM-Interleaved | arXiv | 2024-01-18| Shanghai AI Lab, CUHK, THU, SenseTime, UofT | [Github](https://github.com/OpenGVLab/MM-Interleaved) | - |
